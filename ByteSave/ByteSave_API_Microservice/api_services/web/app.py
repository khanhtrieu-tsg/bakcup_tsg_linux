...
from services import hello, Service, Load_DSD, Del_Service, Service_KH
from service_storage import Service_Storage, Del_Service_Storage
...
api.add_resource(Service, '/dich-vu')
api.add_resource(Service_KH, '/dich-vu/<idkh>')
api.add_resource(Load_DSD, '/dich-vu/loadding/<id>')
api.add_resource(Del_Service, '/dich-vu/xoa/<id>')
api.add_resource(Service_Storage, '/dich-vu-luu-tru/<id>')
api.add_resource(Del_Service_Storage, '/dich-vu-luu-tru/xoa/<id>')
